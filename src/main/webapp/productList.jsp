...
<div class="address">
    <div class="wrapper clearfix"><a href="index.html">首页</a><span>/</span><a
            href="flowerDer.html">${cate.CATE_NAME}</a><span>/</span><a href="proList.html" class="on">${cate.CATE_NAME}</a></div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">${cate.CATE_NAME}</h3>
...
<ul class="proList wrapper clearfix">
    <c:forEach var="p" items="${pList}">
        <li>
            ...
            <dl>
                <dt><img src="img/products/${p.PRODUCT_IMG_NAME}"></dt>
                <dd>【Disino】${p.PRODUCT_NAME}</dd>
