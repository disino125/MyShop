...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="img/products/${p.PRODUCT_IMG_NAME}"/>
                <div class="smallImg clearfix"><img src="img/products/${p.PRODUCT_IMG_NAME}"
            ...
            <div class="fr intro">
                <div class="title"><h4>【Disino】${p.PRODUCT_NAME}</h4>
                    <p>【${p.PRODUCT_DESCRIPTION}】</p><span>￥${p.PRODUCT_PRICE}.00</span></div>
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ"><p class="fl"><img src="img/products/${p.PRODUCT_IMG_NAME}"
                                                                            alt="白瓷花瓶+20支快乐花"
                    ...
                    <div class="num clearfix">
                        ...
                        <span id="productCount" class="fl" contentEditable="true">1</span>
                        <img class="fl add" src="img/temp/add.jpg">
                        <p class="please fl">请选择商品属性!</p>
                    </div>
                </div>
                <div class="btns clearfix">
                    <a href="javascript:buyAndCart(${p.PRODUCT_ID},'b')"><p class="buy fl">立即购买</p></a>
                    <a href="javascript:buyAndCart(${p.PRODUCT_ID},'c')"><p class="cart fr">加入购物车</p></a>
                </div>
                <script>
                    function buyAndCart(pid,flag) {
                        var count = document.getElementById("productCount").innerHTML;
                        location.href="cartAdd?pid="+pid+"&count="+count+"&flag="+flag;
                    }
                </script>
            </div>
        </div>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr"><h4>为你推荐</h4>
        <div class="seeList">
            <c:forEach var="cp" items="${rl}">
                <a href="selectProductDetail?id=${cp.PRODUCT_ID}">
                    <dl>
                        <dt><img src="img/products/${cp.PRODUCT_IMG_NAME}" height="200" width="161"></dt>
                        <dd>【Disino】${cp.PRODUCT_NAME}</dd>
    ...
    <div class="bottom">
        ...
        <div class="imgCon bd">
            <div class="likeList clearfix">
                <div>
                    <c:forEach var="r" items="${recently}">
                        <a href="selectProductDetail?id=${r.PRODUCT_ID}">
                            <dl>
                                <dt><img src="img/products/${r.PRODUCT_IMG_NAME}" width="216" height="216"></dt>
                                <dd>【Disino】${r.PRODUCT_NAME}</dd>
                                <dd>￥${r.PRODUCT_PRICE}.00</dd>
                            </dl>
                        </a>
                    </c:forEach>
