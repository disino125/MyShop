...
<%@ include file="admin_menu.jsp"  %>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>Willkommen『Disino』MyShop_Projekt</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="insert.html"><i class="icon-font">&#xe001;</i>User hinfügen</a>
                    <a href="insert.html"><i class="icon-font">&#xe005;</i>Produkt hinfügen</a>
                    <a href="insert.html"><i class="icon-font">&#xe048;</i>Kategorie hinfügen</a>
                    <a href="#"><i class="icon-font">&#xe01e;</i>Kommentar</a>
                </div>
            </div>
        </div>
        <div class="result-wrap">
