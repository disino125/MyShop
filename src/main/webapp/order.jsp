        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.html" class="fr">返回购物车</a></h3><!--------ul---------------->
                <c:forEach var="oc" items="${ocs}">
                    <ul class="clearfix">
                        <li class="fl"><img src="img/products/${oc.CART_P_IMG}" width="110" height="110"></li>
                        <li class="fl"><p>${oc.CART_P_NAME}</p>
                            <p>颜色分类：gggg</p>
                            <p>数量：${oc.CART_P_QUANTITY}</p></li>
                        <li class="fr">￥${oc.CART_P_PRICE*oc.CART_P_QUANTITY}.00</li>
                    </ul>
                </c:forEach>

            </div><!--------tips---------------->
            <div class="tips"><p><span class="fl">商品金额：</span><span class="fr">￥${total}.00</span></p>
                <p><span class="fl">优惠金额：</span><span class="fr">￥0.00</span></p>
                <p><span class="fl">运费：</span><span class="fr">免运费</span></p></div><!--------tips count---------------->
            <div class="count tips"><p><span class="fl">合计：</span><span class="fr">￥${total}.00</span></p></div>
